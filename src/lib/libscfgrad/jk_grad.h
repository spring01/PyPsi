...
public:
    JKGrad(int deriv, boost::shared_ptr<BasisSet> primary, Process::Environment& process_environment_in);
    virtual ~JKGrad();
    ...
    */
    static boost::shared_ptr<JKGrad> build_JKGrad(Process::Environment& process_environment_in, int deriv = 1);
...
public:
    DFJKGrad(int deriv, boost::shared_ptr<BasisSet> primary, boost::shared_ptr<BasisSet> auxiliary, Process::Environment& process_environment_in);
    virtual ~DFJKGrad();
...
public:
    DirectJKGrad(int deriv, boost::shared_ptr<BasisSet> primary, Process::Environment& process_environment_in);
